                ...
                <div class="col-lg-8 mb-5">
                    ...
                    <div class="row mx-n2 mb-3">
                        <div class="col-md-3 col-6 px-2 pb-2">
                            <img class="img-fluid w-100" src="<?php echo $row['carimagename'] ?>" alt="">
                        </div>
                        <div class="col-md-3 col-6 px-2 pb-2">
                            <img style="-webkit-transform: scaleX(-1);transform: scaleX(-1);" class="img-fluid w-100" src="<?php echo $row['carimagename'] ?>" alt="">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 mb-5">
                    <div class="bg-secondary p-5">
                        ...
                        <div class="form-group">
                            <select required name="pickuploc" id="pickuploc" class="custom-select px-4" style="height: 50px;">
                        ...
                        <div class="form-group">
                            <select required name="droploc" id="droploc" class="custom-select px-4" style="height: 50px;">
                        ...
                        <div class="form-group mb-0">
                            <input type="hidden" name="carid" id="carid" value="<?php echo $row['carid'] ?>">
                            <input class="btn btn-primary btn-block" type="submit" style="height: 50px;" value="Check Now" name="book">
                        </div>
                        </form>
